package com.example.piyathatcharoensak.temperatureconverter;
...
import com.example.piyathatcharoensak.temperatureconverter.Model.Body;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button c_to_f = findViewById(R.id.CF);
        ...
        Button f_to_c = findViewById(R.id.FC);
